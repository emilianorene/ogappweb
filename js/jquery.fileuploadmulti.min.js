 ...
 */ (function(b) {
	...
	b.fn.uploadFile = function(t) {
		var r = b.extend({
			...
			dragDropStr: "<span><b>Arrastre las imagenes</b></span>",
			abortStr: "Abortar",
			cancelStr: "Cancelar",
			deletelStr: "Borrar",
			doneStr: "Listo",
			multiDragErrorStr: "No se pueden arrastras varias imagenes.",
			extErrorStr: "no esta permitido. Extensiones permitidas: ",
			sizeErrorStr: "no esta permitido. Tamaño maximo permitido: ",
			uploadErrorStr: "No esta permitido subir",
			maxFileCountErrorStr: " no esta permitido. Maxica cantidad de imagenes:"
		}, t);
		this.fileCounter = 1;
